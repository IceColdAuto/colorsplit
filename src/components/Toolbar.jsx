    ...
    >
      ...
      <div className="flex items-center px-3 pb-2.5 gap-1">
        <button
          ...
          style={{ touchAction: 'manipulation' }}
          className="w-10 h-10 flex items-center justify-center rounded-xl text-ink/70 active:scale-90 transition-all bg-white/80 border border-ink/8"
        >
        ...
        <button
          ...
          className={`w-10 h-10 flex items-center justify-center rounded-xl transition-all active:scale-90 ${
            tool === 'pencil' ? 'bg-blue-500 text-white shadow-lifted' : 'bg-white/80 border border-ink/8 text-ink/70'
          }`}
        >
        ...
        <button
          ...
          style={{ touchAction: 'manipulation' }}
          className={`w-10 h-10 flex items-center justify-center rounded-xl transition-all active:scale-90 ${
            tool === 'eraser' ? 'bg-blue-500 text-white shadow-lifted' : 'bg-white/80 border border-ink/8 text-ink/70'
          }`}
        >
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button
          ...
          style={{ touchAction: 'manipulation' }}
          className={`w-10 h-10 flex items-center justify-center rounded-xl transition-all active:scale-90 ${
            tool === 'eyedropper' ? 'bg-blue-500 text-white shadow-lifted' : 'bg-white/80 border border-ink/8 text-ink/70'
          }`}
